<?php
	$result2=mysql_query("select p.IdPost as id, p.DataPost as Data, p.Ora as Ora, p.IdLuogo as Luogo, s.Testo as stato from Post p natural join Stati s where p.IdBacheca='$bacheca'");
