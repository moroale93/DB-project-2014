<?php
	$result2=mysql_query("select p.IdPost as id, p.DataPost as Data, p.Ora as Ora, p.IdLuogo as Luogo, f.Fotografia as foto from Post p natural join Foto f where p.IdBacheca='$idBacheca'");
